...
namespace D2P0JX_HFT_2021221.Data.DbContexts
{
    public class PizzaDbContext : DbContext
    {
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            optionsBuilder
                ...
                .UseSqlServer(@"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=|DataDirectory|\D2P0JXDb.mdf;Integrated Security=true;MultipleActiveResultSets=True; MultipleActiveResultSets=True");
        }
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            var margherita = new Pizza() { Id = 1, Name = "Margherita Pizza", Price = 1100, Size =32, RestaurantId =donpepe.Id };
            var hawaiian = new Pizza() { Id = 2, Name = "Hawaiian Pizza", Price = 1500, Size = 45, RestaurantId = donpepe.Id };
            var cheese = new Pizza() { Id = 3, Name = "Cheese Pizza", Price = 1400, Size = 32, RestaurantId = pizzahut.Id };
            var buffalo = new Pizza() { Id = 4, Name = "Buffalo Pizza", Price = 1700, Size = 45, RestaurantId = pizzahut.Id };
            var pepperoni = new Pizza() { Id = 5, Name = "Pepperoni Pizza", Price = 1300, Size = 32, RestaurantId = pizzaforte.Id };
            var veggie = new Pizza() { Id = 6, Name = "Veggie Pizza", Price = 1900, Size = 45, RestaurantId = pizzaforte.Id };
